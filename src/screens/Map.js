  ...
  render() {
    ...
    return (
      <div className="mapScreen">
        <header>
          <button onClick={() => this.changeMode('couriers')} className="pointer buttonActive">Coursiers</button>
          <button onClick={() => this.changeMode('livraisons')} className="pointer">Livraisons</button>
        </header>
        <iframe
